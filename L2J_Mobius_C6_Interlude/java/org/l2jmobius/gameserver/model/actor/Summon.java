...
public abstract class Summon extends Playable
{
	...
	public Summon(int objectId, NpcTemplate template, Player owner)
	{
		...
		final Location location = GeoEngine.getInstance().getValidLocation(x, y, z, x + Rnd.get(-100, 100), y + Rnd.get(-100, 100), z, getInstanceId());
	 ...
	 * @see org.l2jmobius.gameserver.model.actor.Creature#doCast(org.l2jmobius.gameserver.model.Skill)
	 */
	@Override
