...
public class Warehouse extends Folk
{
	 ...
	 */
	public Warehouse(int objectId, NpcTemplate template)
	{
	 ...
	 * @param player the player
	 */
	private void showDepositWindowFreight(Player player)
	{
	 ...
	 */
	private void showDepositWindowFreight(Player player, int objId)
	{
		player.sendPacket(ActionFailed.STATIC_PACKET);
		final Player destChar = Player.load(objId);
		if (destChar == null)
		{
