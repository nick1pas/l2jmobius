...
public class GeoEngine
{
	 ...
	 */
	public Location canMoveToTargetLoc(int x, int y, int zValue, int tx, int ty, int tzValue, Instance instance)
	{
	 ...
	 */
	public boolean canMoveToTarget(int fromX, int fromY, int fromZvalue, int toX, int toY, int toZvalue, Instance instance)
	{
