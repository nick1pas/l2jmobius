...
public class ManorManager extends Merchant
{
	public ManorManager(int objectId, NpcTemplate template)
	{
	...
	private void showBuyWindow(Player player, String value)
	{
			...
			switch (ask)
			{
				case 1: // Seed purchase
				{
					...
					else
					{
						...
						{
							final Item item = ItemTable.getInstance().createDummyItem(s.getId());
