...
-- Remove Scout's Corpse spawn.
DELETE FROM `spawnlist` WHERE `npc_templateid` IN ('32015');
...
-- Remove Primeval Isle (20_17) spawns.
DELETE FROM spawnlist WHERE (locx>=0 AND locy>=-32768 AND locx<=32768 AND locy<=0);

-- Remove Town of Schuttgart (22_13) spawns.
DELETE FROM spawnlist WHERE (locx>=65536 AND locy>=-163840 AND locx<=98303 AND locy<=-131073);

-- Remove Panderous Plains (23_13) spawns.
DELETE FROM spawnlist WHERE (locx>=98304 AND locy>=-163840 AND locx<=131071 AND locy<=-131073);

-- Remove Crypts of Disgrace (21_14) spawns.
DELETE FROM spawnlist WHERE (locx>=32768 AND locy>=-131072 AND locx<=65535 AND locy<=-98305);

-- Remove Pavel Ruin (22_14) spawns.
DELETE FROM spawnlist WHERE (locx>=65536 AND locy>=-131072 AND locx<=98303 AND locy<=-98305);

-- Remove Frozen Labyrinth (23_14) spawns.
DELETE FROM spawnlist WHERE (locx>=98304 AND locy>=-131072 AND locx<=131071 AND locy<=-98305);
